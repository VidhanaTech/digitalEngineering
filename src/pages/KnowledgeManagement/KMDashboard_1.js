...
import KMStackedBarChart from "./KMStackedBarChart";
...
const KMDashboard1 = (state) => {
  ...
  const postArticle = () => {
    ...
    if (content === "" || content.length < 20) {
      // if (content === "" ) {
      setDisabled(false);
      setContentError("Enter content, must contain 20 characters atleast");
      hasError = true;
    }
    if (hasError) {
      setDisabled(false);
  ...
  const autofill = () => {
    apiClient
      .get("/vxarticle/get_source_title/" + category)
      .then((response) => {
        let parr = [];
      ...
      >
        ...
        {isLoading ? (
          ...
          >
            <div className="flex flex-col w75">
              <p>
                <strong>{cardValue.activeusers} </strong>
                {/* {cardValue.user_status === " Increase " ? (
                  <FontAwesomeIcon
                    icon={faCircleChevronUp}
                    className="clrGreen ml1"
        ...
        {isLoading ? (
          ...
          >
            <div className="flex flex-col w75">
              ...
              <span className="span_text">Star of the month</span>
            </div>
        ...
        {isLoading ? (
          ...
          >
            <div className="flex flex-col w75">
              ...
              <span className="span_text" style={{ fontSize: "14px" }}>
                Star Project
              </span>
