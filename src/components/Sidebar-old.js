          ...
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <CollapsableNavItem
                ...
                icon={faFileAlt}>
                <NavItem
                  title="Search Client Summary"
                  link={Routes.Signin.path}
                />
                <NavItem
                  title="View Client"
                  link={Routes.ViewClient.path}
                />
                <NavItem
                  title="Add Client"
              ...
              <CollapsableNavItem
                ...
                <NavItem
                  title="Build Tools"
                  link={Routes.DocsBuild.path}
                />
                <NavItem
                  title="Changelog"
                  link={Routes.DocsChangelog.path}
                />
              </CollapsableNavItem>
              <NavItem title="WST Defaulters" eventKey="wst/" icon={faChartBar} link={Routes.WST.path}></NavItem>

              <CollapsableNavItem title="User Management" icon={faChartBar}>
                <NavItem title="Add User / Role" eventKey="userManage/" icon={faChartBar} link={Routes.UserM.path}></NavItem>
              </CollapsableNavItem>
              <CollapsableNavItem
                eventKey="components/"
                title="Components"
